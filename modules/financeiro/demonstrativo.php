...
<h3>Demonstrativo de Resultados do Exercício (DRE)</h3>
	  ...
	  <div class="form-row">
	  	<div class="col">
	  	  <div class="form-group">
	  	    <label for="dre_tipo">Tipo de demonstrativo</label>
	  	    <select name="dre_tipo" id="dre_tipo" class="form-control">
	  	  	  <option value="1" <?php echo isset($param["dre_tipo"]) && $param["dre_tipo"] == 1 ? "selected" : ""?>>Mensal</option>
	  	  	  <option value="2" <?php echo isset($param["dre_tipo"]) && $param["dre_tipo"] == 2 ? "selected" : ""?>>Mensal comparado</option>
	  	  	  <option value="3"<?php echo isset($param["dre_tipo"]) && $param["dre_tipo"] == 3 ? "selected" : ""?>>Anual comparado</option>
	  	    </select>
	  	  </div>
	  	</div>
		<div class="col">
		...
		<div class="col-md-2">
	      <div class="form-group">
	        <label for="data_ref">Mês de referência</label>
	        <input type="text" class="form-control monthpicker" name="data_ref" id="data_ref" value="<?php echo $data_ref->format("m/Y"); ?>">
	      </div>
		</div>
		<div class="col-md-2">
	      <div class="form-group">
	        <label for="data_comp">Mês de comparação</label>
	        <input type="text" class="form-control monthpicker" name="data_comp" id="data_comp" value="<?php echo $data_comp->format("m/Y"); ?>">
	      </div>
		</div>
	  </div>
	  <button type="submit" class="btn btn-primary"><span class="fas fa-th-list"></span> Gerar demonstrativo</button>
	</form>

	<form action="print.php?mod=financeiro&pag=demonstrativo&func=imprimir" method="post" target="_blank" class="float-right" style="margin-top:-2.5em;">
	  <?php 
